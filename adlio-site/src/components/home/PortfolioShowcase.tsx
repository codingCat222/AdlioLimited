...
const industries = [
  { label: "Banking", sub: "Financial institutions" },
  { label: "Government", sub: "Public sector agencies" },
  { label: "Healthcare", sub: "Health tech systems" },
  { label: "SMEs", sub: "Growing businesses" },
];
