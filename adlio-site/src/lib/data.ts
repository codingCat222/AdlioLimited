export const companyInfo = {
  name: "Adlio Limited",
  founded: 2020,
  tagline: "Building smarter businesses through technology.",
  vision: "To become one of Africa's leading technology companies, empowering businesses and institutions through innovative digital solutions that drive efficiency, growth, and transformation.",
  mission: "To develop world-class technology solutions that help organizations automate processes, optimize performance, improve customer engagement, and achieve operational excellence through innovation, expertise, and exceptional service delivery.",
};

export const services = [
  {
    title: "Custom Software Development",
    description: "We design and develop tailor-made software applications that align with specific business requirements, helping organizations automate workflows, improve productivity, and gain greater operational control.",
    category: "Engineering",
  },
  {
    title: "Enterprise Application Development",
    description: "Our team develops robust enterprise-grade solutions that support large-scale operations, data management, reporting, compliance, and business intelligence.",
    category: "Engineering",
  },
  {
    title: "Web Application Development",
    description: "We create secure, scalable, and responsive web applications that enable organizations to deliver seamless digital experiences across devices and platforms.",
    category: "Engineering",
  },
  {
    title: "Mobile Application Development",
    description: "Our mobile solutions help businesses connect with customers, employees, and stakeholders through intuitive Android and iOS applications.",
    category: "Engineering",
  },
  {
    title: "FinTech Solutions",
    description: "With extensive experience working with financial institutions, we develop secure banking and financial technology solutions that support customer onboarding, transaction processing, reporting, compliance, and operational efficiency.",
    category: "FinTech",
  },
  {
    title: "Digital Transformation Consulting",
    description: "We help organizations modernize legacy systems, optimize business processes, and leverage emerging technologies to remain competitive in an evolving digital landscape.",
    category: "Consulting",
  },
  {
    title: "Systems Integration",
    description: "Our integration services enable businesses to connect multiple systems, applications, and databases into a unified technology ecosystem that improves efficiency and data accuracy.",
    category: "Integration",
  },
  {
    title: "Business Process Automation",
    description: "We implement intelligent automation solutions that reduce manual workloads, improve accuracy, and accelerate business operations.",
    category: "Automation",
  },
  {
    title: "Cloud Solutions",
    description: "We assist organizations in adopting cloud technologies that improve scalability, security, accessibility, and business continuity.",
    category: "Cloud",
  },
  {
    title: "Technical Support and Maintenance",
    description: "Our commitment extends beyond deployment. We provide ongoing support, system monitoring, maintenance, and enhancements to ensure long-term performance and reliability.",
    category: "Support",
  },
];
...
export const coreValues = [
  { title: "Excellence", description: "We strive for the highest standards in every project we undertake." },
  { title: "Innovation", description: "We embrace creativity and technology to solve complex business challenges." },
  { title: "Integrity", description: "We operate with honesty, transparency, and professionalism." },
  { title: "Customer Success", description: "Our clients' success remains the foundation of our own growth." },
  { title: "Accountability", description: "We take ownership of our commitments and consistently deliver results." },
  { title: "Continuous Improvement", description: "We continuously learn, evolve, and improve to remain at the forefront of technology innovation." },
];
